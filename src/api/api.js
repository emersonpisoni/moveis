...
export function http() {
  const base_url = 'https://itemdonationapp.azurewebsites.net'
  ...
  async function login(email, senha) {
    return await axios.get(`${base_url}/pessoa/${email}/${senha}`)
  }

  async function postDonation({ titulo, descricao, conservacaoId, categoriaId, itemId, endereco, bairro, cidade, estado, status, retirar = true, formData }) {
    // return await axios(config)
    formData.append('titulo', titulo);
    formData.append('descricao', descricao);
    formData.append('retirar', retirar);
    formData.append('conservacaoId', conservacaoId);
    ...
    return await axios.post(`${base_url}/doacao`, formData)
  }
